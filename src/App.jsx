...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {["bottom-0 left-0 -rotate-45", "top-0 right-10 -rotate-45"].map((pos, i) => (
        <div
          key={i}
          className={`absolute ${pos} w-[690px] h-[267px] z-20`}
          style={{
            clipPath: "path('M1.86617 231.405C-5.41886 205.999 9.27103 179.497 34.6769 172.212L628.745 1.86618C654.151 -5.41884 680.652 9.27101 687.937 34.6769C695.222 60.0828 680.532 86.5841 655.126 93.8691L61.0584 264.215C35.6525 271.5 9.1512 256.81 1.86617 231.405Z')",
            WebkitClipPath: "path('M1.86617 231.405C-5.41886 205.999 9.27103 179.497 34.6769 172.212L628.745 1.86618C654.151 -5.41884 680.652 9.27101 687.937 34.6769C695.222 60.0828 680.532 86.5841 655.126 93.8691L61.0584 264.215C35.6525 271.5 9.1512 256.81 1.86617 231.405Z')",
            backgroundImage: bgImage,
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundAttachment: "fixed",
